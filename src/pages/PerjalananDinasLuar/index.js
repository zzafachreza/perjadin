...
export default function Perjalanandinasluar({navigation}) {
    const backPage = () => {
        navigation.goBack()
    }
  return (
    ...
    {/* HADERS */}
    <MyHeader judul="Perjalanan Dinas Luar" onPress={backPage}/>
    ...
    <ScrollView>
    <View style={{padding:10}}>
        {/* NANTI DISINI ADA DATA DATA ORANG YANG DINAS PERJALANAN DINAS LUAR */}
